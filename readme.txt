...
The Populum (Latin for *People*) mod's goal is to link all the classes together in a thematic, story-like fashion based loosely on French and Raven's Five Forms of Power and systems of government, connecting to social, political, and economic attributes. Populum increases the depth of economy management and expands the early and late game of the classes by introducing new options. You will find that many commander units, especially spell-casters, will have some ritual powers and in some circumstances may be able to change into other classes or units.
...
**Uninstallation note:** Use the unsubscribe button in the Steam Workshop.
...
*   [Populum MOD Github](https://github.com/Exxxx/populum-mod)
*   [Map of Populum Paths (Old Reference)](https://drive.google.com/open?id=19h6MOrRvle8WhzF8QrCkJ9l9ULZuMctE)
    *Dotted lines indicate a connected person that is required to be present or may cast the ritual required.*
